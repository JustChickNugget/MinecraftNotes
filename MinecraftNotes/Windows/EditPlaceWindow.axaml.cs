...
public partial class EditPlaceWindow : Window
{
    ...
    private void SaveButton_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(EditPlaceWindow), nameof(SaveButton_OnClick));
        }
    }
    ...
    private void Window_OnKeyDown(object? sender, KeyEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(EditPlaceWindow), nameof(Window_OnKeyDown));
        }
    }
