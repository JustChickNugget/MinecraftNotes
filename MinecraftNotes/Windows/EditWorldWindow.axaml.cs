...
public partial class EditWorldWindow : Window
{
    ...
    private void SaveButton_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(EditWorldWindow), nameof(SaveButton_OnClick));
        }
    }
    ...
    private void Window_OnKeyDown(object? sender, KeyEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(EditWorldWindow), nameof(Window_OnKeyDown));
        }
    }
