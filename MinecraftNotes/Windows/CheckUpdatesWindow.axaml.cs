...
public partial class CheckUpdatesWindow : Window
{
    ...
    private async void CheckButton_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        catch (Exception exception)
        {
            ...
            ToolBox.PrintException(this, exception, nameof(CheckUpdatesWindow), nameof(CheckButton_OnClick));
        }
    }
    ...
    private void Window_OnKeyDown(object? sender, KeyEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(CheckUpdatesWindow), nameof(Window_OnKeyDown));
        }
    }
