...
using Location = MinecraftNotes.Structs.Location;
...
public partial class MainWindow : Window
{
    ...
    private void AddWorldButton_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(AddWorldButton_OnClick));
        }
    }
    ...
    private void RefreshMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(RefreshMenuItem_OnClick));
        }
    }
    ...
    private void WorldExtractMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(WorldExtractMenuItem_OnClick));
        }
    }
    ...
    private async void WorldEditMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(WorldEditMenuItem_OnClick));
        }
    }
    ...
    private void WorldDeleteMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(WorldDeleteMenuItem_OnClick));
        }
    }
    ...
    /// <param name="sender">Sender object</param>
    /// <param name="e">Event arguments</param>
    private void PlaceDataGridExtractWithWorldNameMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        try
        {
    ...
    /// <param name="sender">Sender object</param>
    /// <param name="e">Event arguments</param>
    private void PlaceDataGridExtractWithoutWorldNameMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        try
        {
            if (PlaceDataGrid.SelectedItem == null)
    ...
    private async void PlaceDataGridEditMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(PlaceDataGridEditMenuItem_OnClick));
        }
    }
    ...
    /// <param name="sender">Sender object</param>
    /// <param name="e">Event arguments</param>
    private void PlaceDataGridDeleteMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        try
        {
            if (MainViewModel.Worlds == null || MainViewModel.Worlds.Count <= 0 || PlaceDataGrid.SelectedItem == null)
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(PlaceDataGridDeleteMenuItem_OnClick));
        }
    }
    ...
    private void ViewSaveDirectoryMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(ViewSaveDirectoryMenuItem_OnClick));
        }
    }
    ...
    private void AboutApplicationMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(AboutApplicationMenuItem_OnClick));
        }
    }
    ...
    private void CheckForUpdatesMenuItem_OnClick(object? sender, RoutedEventArgs e)
    {
        try
        {
            ...
            checkUpdatesWindow.ShowDialog(this);
        }
        catch (Exception exception)
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(CheckForUpdatesMenuItem_OnClick));
        }
    }
    ...
    private void Window_OnLoaded(object? sender, RoutedEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(Window_OnLoaded));
        }
    }
    ...
    private void Window_OnKeyDown(object? sender, KeyEventArgs e)
    {
        ...
        {
            ToolBox.PrintException(this, exception, nameof(MainWindow), nameof(Window_OnKeyDown));
        }
    }
